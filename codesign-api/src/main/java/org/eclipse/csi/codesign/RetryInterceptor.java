...
public class RetryInterceptor implements Interceptor {
   ...
   *
   * <p>Retries on HTTP {@code 429}, {@code 502}, {@code 503}, {@code 504} and {@link IOException},
   * up to {@code maxRetries} times or until the deadline is exceeded.
   *
  ...
  public Response intercept(Chain chain) throws IOException {
    ...
    while (true) {
      ...
      LOG.log(
          Level.WARNING,
          "Request returned HTTP {0}. Retrying...",
  ...
  private void sleep() {
    try {
      LOG.log(
          Level.INFO,
          "Waiting {0} seconds before next retry",
